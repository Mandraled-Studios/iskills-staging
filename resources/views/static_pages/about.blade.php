<x-app-layout>
    <div class="overflow-hidden bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
          <div class="max-w-4xl">
            <p class="text-base/7 font-semibold text-secondary">Get to know</p>
            <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">About Us</h1>
            <p class="mt-6 text-balance text-xl/8 text-gray-700">I Skills Solutions is one of the reckoned names in the training & Placement 
                sector imparting healthcare services to Private business enterprises, institutions and individuals. </p>
          </div>
          <section class="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
            <div class="lg:pr-8">
              <h2 class="text-pretty text-2xl font-semibold tracking-tight text-gray-900">Our Story</h2>
              <p class="mt-6 text-base/7 text-gray-600">Since our inception 2013, we have done a 
                commendable job in creating value and confidence in every assignment. 
                Our spectrum of training services meets the demands of various sectors. </p>
              <p class="mt-8 text-base/7 text-gray-600"> I Skills provides you with ready-to-work, high-quality training program with 
                Placement in leading companies. Our team comprises of AAPC approved instructors
                and the courses are taught from the AAPC approved curriculum We have trained 
                nearly 5000 fresher candidates in Medical Coding for almost 10 years and 
                placed them in various MNC's. </p>
              <p class="mt-8 text-base/7 text-gray-600"> Our program ranks among the best, with one of the nation's highest exam pass 
                    and pass-percentage rates/ratios. I Skills Solutions reach spans the globe 
                    providing training to students in the India, UAE, United States and all 
                    countries that administer certifications. </p>
            </div>
